...
import { UnitProps } from '../../features/questions_manager/types';
...
export default function SubCategoryPage(props:any) {
    ...
    useEffect(() => {
        if (sub_category) {
            console.log("xxwwwwwwxx", sub_category.units)
        }
    },[sub_category])
    ...
    return (
        <>
            ...
            <div className='flex flex-row justify-start'>
                    ...
                    <div>
                    {sub_category &&
                            <div className=' text-textColor1 bg-green-400 rounded-lg'>
                                <ListUnits units={sub_category.units} />
                            </div>
                        }
                    </div>
