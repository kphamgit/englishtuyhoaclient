...
import { WordScrambleComponentHandle, RadioProps } from './types';
...
export interface EditWordScrambleComponentProps {
    ...
    export const EditWordScramble = forwardRef<WordScrambleComponentHandle, EditWordScrambleComponentProps>((props, ref) => {
...
export default EditWordScramble